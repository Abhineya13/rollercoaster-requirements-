...
public class Main {
    public static void main(String[] args) {
        ...
        int age = scanner.nextInt(); // Person's age
        int height = scanner.nextInt(); // Person's height in cm
        boolean hasAdult = scanner.nextBoolean(); // true if an adult is present, false otherwise
